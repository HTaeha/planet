...
export const protobufPackage = 'coreators.planet.blog'
...
export const MsgCreateTimedoutPost = {
  encode(message: MsgCreateTimedoutPost, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator)
    }
    if (message.title !== '') {
...
export const MsgCreateTimedoutPostResponse = {
  encode(message: MsgCreateTimedoutPostResponse, writer: Writer = Writer.create()): Writer {
    if (message.id !== 0) {
      writer.uint32(8).uint64(message.id)
    }
    return writer
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateTimedoutPostResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgCreateTimedoutPostResponse } as MsgCreateTimedoutPostResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
...
const baseMsgUpdateTimedoutPost: object = { creator: '', id: 0, title: '', chain: '' }

export const MsgUpdateTimedoutPost = {
  encode(message: MsgUpdateTimedoutPost, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator)
    }
    if (message.id !== 0) {
...
export const MsgUpdateTimedoutPostResponse = {
  encode(_: MsgUpdateTimedoutPostResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateTimedoutPostResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgUpdateTimedoutPostResponse } as MsgUpdateTimedoutPostResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
export const MsgDeleteTimedoutPost = {
  encode(message: MsgDeleteTimedoutPost, writer: Writer = Writer.create()): Writer {
    if (message.creator !== '') {
      writer.uint32(10).string(message.creator)
    }
    if (message.id !== 0) {
...
export const MsgDeleteTimedoutPostResponse = {
  encode(_: MsgDeleteTimedoutPostResponse, writer: Writer = Writer.create()): Writer {
    return writer
  },
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteTimedoutPostResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
    const message = { ...baseMsgDeleteTimedoutPostResponse } as MsgDeleteTimedoutPostResponse
    while (reader.pos < end) {
      const tag = reader.uint32()
      switch (tag >>> 3) {
        default:
...
const baseMsgSendIbcPost: object = { creator: '', port: '', channelID: '', timeoutTimestamp: 0, title: '', content: '' }
...
export class MsgClientImpl implements Msg {
  ...
  UpdateSentPost(request: MsgUpdateSentPost): Promise<MsgUpdateSentPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'UpdateSentPost', data)
  ...
  DeleteSentPost(request: MsgDeleteSentPost): Promise<MsgDeleteSentPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'DeleteSentPost', data)
  ...
  CreateTimedoutPost(request: MsgCreateTimedoutPost): Promise<MsgCreateTimedoutPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'CreateTimedoutPost', data)
  ...
  UpdateTimedoutPost(request: MsgUpdateTimedoutPost): Promise<MsgUpdateTimedoutPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'UpdateTimedoutPost', data)
  ...
  DeleteTimedoutPost(request: MsgDeleteTimedoutPost): Promise<MsgDeleteTimedoutPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'DeleteTimedoutPost', data)
  ...
  SendIbcPost(request: MsgSendIbcPost): Promise<MsgSendIbcPostResponse> {
    ...
    const promise = this.rpc.request('coreators.planet.blog.Msg', 'SendIbcPost', data)
