...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/coreators/planet/blog/post
         */
        this.queryPostAll = (query, params = {}) => this.request({
            path: `/coreators/planet/blog/post`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/coreators/planet/blog/post/{id}
         */
        this.queryPost = (id, params = {}) => this.request({
            path: `/coreators/planet/blog/post/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/coreators/planet/blog/sentPost
         */
        this.querySentPostAll = (query, params = {}) => this.request({
            path: `/coreators/planet/blog/sentPost`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/coreators/planet/blog/sentPost/{id}
         */
        this.querySentPost = (id, params = {}) => this.request({
            path: `/coreators/planet/blog/sentPost/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
         ...
         * @request GET:/coreators/planet/blog/timedoutPost
         */
        this.queryTimedoutPostAll = (query, params = {}) => this.request({
            path: `/coreators/planet/blog/timedoutPost`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/coreators/planet/blog/timedoutPost/{id}
         */
        this.queryTimedoutPost = (id, params = {}) => this.request({
            path: `/coreators/planet/blog/timedoutPost/${id}`,
            method: "GET",
            format: "json",
            ...params,
        });
