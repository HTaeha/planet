...
export class QueryClientImpl {
    ...
    Post(request) {
        ...
        const promise = this.rpc.request('coreators.planet.blog.Query', 'Post', data);
        return promise.then((data) => QueryGetPostResponse.decode(new Reader(data)));
    }
    PostAll(request) {
        const data = QueryAllPostRequest.encode(request).finish();
        const promise = this.rpc.request('coreators.planet.blog.Query', 'PostAll', data);
    ...
    SentPost(request) {
        ...
        const promise = this.rpc.request('coreators.planet.blog.Query', 'SentPost', data);
    ...
    SentPostAll(request) {
        ...
        const promise = this.rpc.request('coreators.planet.blog.Query', 'SentPostAll', data);
    ...
    TimedoutPost(request) {
        ...
        const promise = this.rpc.request('coreators.planet.blog.Query', 'TimedoutPost', data);
    ...
    TimedoutPostAll(request) {
        ...
        const promise = this.rpc.request('coreators.planet.blog.Query', 'TimedoutPostAll', data);
